// netlify/functions/analyze-fast.js
// ADVantage Insights Brain Encoder - Fast dashboard metrics
...
export async function handler(event) {
  ...
  try {
    ...
    const systemPrompt = `You are ADVantage Insights Brain Encoder - fast advertising creative intelligence.
...
Return ONLY the fields listed. Do not return scenes, strategic_insights, or cmo_actions. Keep all text fields brief - maximum 2 sentences each.

Return this exact JSON structure. All INT values are integers from 0-100:

{
  "headline_verdict": "One powerful CMO-ready sentence",
  "overall_grade": "A+|A|A-|B+|B|B-|C+|C|C-|D|F",
  "grade_note": "One brief line",
  "creative_summary": "Maximum 2 sentence summary",
  ...
  "attention_curve": [/* exactly ${Math.round(duration)} integers, one per second */],
  "emotion_curve": [/* exactly ${Math.round(duration)} integers, one per second */],
  "emotion_types": {
  ...
  "brain_regions": {
    "visual_cortex": INT,
    "prefrontal_cortex": INT,
    "amygdala": INT,
    "hippocampus": INT,
    "auditory_cortex": INT,
    "mirror_neurons": INT,
    "nucleus_accumbens": INT,
    "anterior_cingulate": INT
  },
  "cognitive_channels": {
    "visual": INT,
    "auditory": INT,
  ...
  "platform_scores": {
    "youtube_preroll_6s": INT,
    "youtube_preroll_15s": INT,
    "youtube_instream": INT,
    "instagram_reels": INT,
    "instagram_stories": INT,
    "instagram_feed": INT,
    "meta_feed": INT,
    "meta_stories": INT,
    "tiktok": INT,
    ...
    "ctv_ott": INT,
    "dooh": INT,
    "programmatic_display": INT
  },
  "competitive_context": {
    "category_avg_viral": INT,
    "category_avg_hook": INT,
    "category_avg_hold": INT,
    "category_avg_recall": INT,
    "position": "above_average|average|below_average|category_leader",
    "benchmark_note": "One brief sentence"
  },
  "sound_analysis": {
    "sound_dependency": INT,
    "music_effectiveness": INT,
    "voiceover_clarity": INT,
    "sound_off_text_quality": INT,
    "asmr_trigger": INT,
    "sonic_branding": INT,
    "sound_note": "Maximum 2 sentences"
  },
  "privacy_and_data_audit": {
    ...
    "privacy_note": "Maximum 2 sentences"
  }
}`;
        ...
        body: JSON.stringify({
          ...
          messages: [{
            ...
            content: [...imageContent, {
              type: "text",
              text: `Score these ${usedFrames.length} frame(s) for ${meta.brand || "this brand"}. ${meta.notes ? "Context: " + meta.notes : ""} Return ONLY the JSON.`
            }]
          }]
        })
      });
    ...
    return { statusCode: 200, headers, body: JSON.stringify({ success: true, analysis: parsed }) };
