export async function generateBrainEncoderPDF(results, form) {
  ...
  function drawHeader(title, pageNum) {
    ...
    setFont(7.5, "bold");
    color(COLORS.gold);
    doc.text("ADVANTAGE INSIGHTS™", 15, 9);
    setFont(9, "normal");
    color(COLORS.dim);
    ...
    setFont(7, "normal");
    color(COLORS.muted);
    doc.text("ADVantage Insights™  |  AdCritIQ™  |  Neural Creative Intelligence  |  Confidential", 15, 293);
  ...
  page("Cover", 1, () => {
    ...
    setFont(9, "bold");
    color(COLORS.gold);
    doc.text("Powered by ADVantage Insights™", W / 2, 263, { align: "center" });
    setFont(7, "normal");
    color(COLORS.muted);
  ...
  page("Methodology & Limitations", 6, () => {
    ...
    setFont(9, "bold");
    color(COLORS.gold);
    doc.text(`Generated by AdCritIQ™ | ADVantage Insights™ | ${reportDate}`, W / 2, 254, { align: "center" });
    setFont(7, "normal");
    color(COLORS.muted);
